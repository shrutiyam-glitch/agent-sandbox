...
export CLUSTER=hpa-ps-cluster #hpa-ps-cluster #change cluster name
export REGION=us-central1 #change region
export NODE_LOCATIONS=${REGION}-c
export NODE_POOL=hpa-ps-nodepool
export NODE_VERSION=1.35.1-gke.1396001
...
export CLUSTER_VERSION=1.35.1-gke.1396001
